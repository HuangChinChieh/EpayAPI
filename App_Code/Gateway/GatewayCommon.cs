...
public static class GatewayCommon
{
    ...
    public static ProviderRequestData GetProviderRequestData(Payment payment)
    {
        ...
        switch (payment.ProviderCode)
        {
            ...
            case "AeePay":
                ...
                break;
            case "wanliuPay":
                providerGateway = new Provider_wanliuPay();
                break;
            case "axecedddPay":
                providerGateway = new Provider_axecedddPay();
                break;
            case "EVOpay":
                providerGateway = new Provider_EVOpay();
                break;
            case "lanhai":
                providerGateway = new Provider_lanhai();
                break;
            case "SGPay":
                providerGateway = new Provider_SGPay();
                break;
            case "EShopPay":
                providerGateway = new Provider_EShopPay();
                break;
            case "ucpay":
                providerGateway = new Provider_ucpay();
                break;
            case "ryuta":
                providerGateway = new Provider_ryuta();
                break;
            case "AIPay":
                providerGateway = new Provider_AIPay();
                break;
             case "JiuYuanPay":
                providerGateway = new Provider_JiuYuanPay();
                break;
            default:
                return null;
                break;
    ...
    public static ReturnWithdrawByProvider SendWithdraw(Withdrawal withdrawal)
    {
        ...
        switch (withdrawal.ProviderCode)
        {
            ...
            case "AeePay":
                ...
                break;
            case "JBP":
                providerGateway = new Provider_JBP();
                break;
            case "ryuta":
                providerGateway = new Provider_ryuta();
                break;
    ...
    public static JArray GetWithdrawBankSettingData(string Currency = "")
    {
        ...
        if (Currency == "TWD")
        {
            path = Pay.ProviderSettingPath + "\\" + "withdrawBankTW"  + ".json";
        }
    ...
    public static string RequestGetAPIByAuthorization(string Url, string JsonString, string PaymentSerial, string ProviderCode, string Authorization)
    {
        string result = null;
        using (HttpClientHandler handler = new HttpClientHandler())
        {
        ...
        using (HttpClientHandler handler = new HttpClientHandler())
        {
            ...
            using (HttpClient client = new HttpClient(handler))
            {
                ...
                retry:
                    ...
                    HttpResponseMessage response = null;
                    PayDB.InsertPaymentTransferLog("1", 2, gPayReturn.SetByPaymentRetunData.PayingSerial, ProviderCode);
        ...
        using (HttpClientHandler handler = new HttpClientHandler())
        {
            ...
            using (HttpClient client = new HttpClient(handler))
            {
                try
                {
                    ...
                    PayDB.InsertPaymentTransferLog("2", 2, gPayReturn.SetByPaymentRetunData.PayingSerial, ProviderCode);
        ...
        using (HttpClientHandler handler = new HttpClientHandler())
        {
            ...
            using (HttpClient client = new HttpClient(handler))
            {
                try
                {
                    ...
                    HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, Pay.ProxyServerUrl);
                    HttpResponseMessage response = null;
                    PayDB.InsertPaymentTransferLog("3", 2, gPayReturn.SetByPaymentRetunData.PayingSerial, ProviderCode);
                    #region  設定相關網址內容
        ...
        using (HttpClientHandler handler = new HttpClientHandler())
        {
            using (HttpClient client = new HttpClient(handler))
            {
                ...
                retry:
                    HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, Pay.ProxyServerUrl);
                    HttpResponseMessage response = null;
                    PayDB.InsertPaymentTransferLog("4", 2, gPayReturn.SetByPaymentRetunData.PayingSerial, ProviderCode);
                    #region  設定相關網址內容
                ...
                retry:
                    ...
                    if (response != null)
                    {
                        if (response.IsSuccessStatusCode == true)
                        {
                            ...
                            {
                                PayDB.InsertPaymentTransferLog("状态码:" + response.StatusCode + ",商户未打印SUCCESS,商戶回覆資訊:"+ strResult, 6, gPayReturn.SetByWithdrawRetunData.WithdrawSerial, ProviderCode);
                                if (retryCount < 2)
                                {
                                    retryCount++;
                                    goto retry;
        ...
        using (HttpClientHandler handler = new HttpClientHandler())
        {
            ...
            using (HttpClient client = new HttpClient(handler))
            {
                try
                {
                    ...
                    string json = JsonConvert.SerializeObject(gPayReturn.SetByWithdrawRetunData);
                    request.Content = new StringContent(json, Encoding.UTF8, "application/json");
                    PayDB.InsertPaymentTransferLog(json, 6, gPayReturn.SetByWithdrawRetunData.WithdrawSerial, ProviderCode);
                    response = client.SendAsync(request).GetAwaiter().GetResult();
                    #endregion
                    #endregion
    ...
    public class GPayReturnByWithdraw
    {
        ...
        public void SetByWithdraw(Withdrawal withdrawal, WithdrawResultStatus withdrawalStatus)
        {
            ...
            this.SetByWithdrawRetunData.WithdrawCharge = withdrawal.CollectCharge + (withdrawal.DownRate * withdrawal.Amount * 0.01M);
    ...
    public class GPayReturnBySimpleWithdraw
    {
        ...
        public void SetByWithdraw(Withdrawal withdrawal)
        {
            ...
            this.SimpleWithdrawReturnData.WithdrawAmount = withdrawal.Amount + withdrawal.CollectCharge+(withdrawal.DownRate * withdrawal.Amount * 0.01M);
