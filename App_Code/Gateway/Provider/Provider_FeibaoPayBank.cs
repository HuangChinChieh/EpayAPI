...
/// </summary>
public class Provider_FeibaoPayBank : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_FeibaoPayBank()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("FeibaoPayBank");
    }
        ...
        try
        {
            if (!string.IsNullOrEmpty(jsonStr))
            {
                ...
                else
                {
                    ...
                    return "error:" + revjsonObj["msg"].ToString();
                }
            }
            else
            {
