...
/// </summary>
public class Provider_FeibaoPay : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_FeibaoPay()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("FeibaoPay");
    }
