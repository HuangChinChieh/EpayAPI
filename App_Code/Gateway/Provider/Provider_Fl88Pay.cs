...
/// </summary>
public class Provider_Fl88Pay : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_Fl88Pay()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("Fl88Pay");
    }
    ...
    string GatewayCommon.ProviderGateway.GetCompleteUrl(GatewayCommon.Payment payment)
    {
        ...
        signDic.Add("productId", "8001");//待確認
        signDic.Add("mchOrderNo", payment.PaymentSerial);//
        signDic.Add("amount", payment.OrderAmount.ToString("#.##"));//
        signDic.Add("currency", payment.CurrencyType);//
        signDic.Add("notifyUrl", SettingData.NotifyAsyncUrl);//
        signDic.Add("subject", "測試商品");//待確認
        signDic.Add("body", "測試商品描述");//待確認
        signDic.Add("reqTime", sendTime);//
        signDic.Add("version", "1.0");//
        signDic.Add("bankCode", "");//待確認
        signDic.Add("bankCardNo", "");//待確認
        signDic.Add("bankCardOwner", "");//待確認
