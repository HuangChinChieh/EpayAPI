...
/// </summary>
public class Provider_FeibaoPayPaymaya : GatewayCommon.ProviderGateway, GatewayCommon.ProviderGatewayByWithdraw
{

    public Provider_FeibaoPayPaymaya()
    {
        //初始化設定檔資料
        SettingData = GatewayCommon.GetProverderSettingData("FeibaoPayPaymaya");
    }
